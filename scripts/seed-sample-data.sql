...
INSERT INTO query_logs (id, user_id, question, response, sources, timestamp) VALUES
  (
    ...
    'Axis Bluechip Fund has delivered an annualized return of 13.2% over the last 5 years, significantly outperforming the benchmark Nifty 100 index. The fund focuses on large-cap stocks and maintains a moderate risk profile with an expense ratio of 1.8%. Current AUM stands at ₹15,000 crores. Key holdings include Reliance Industries, HDFC Bank, and Infosys. The fund is suitable for investors with moderate risk appetite looking for long-term wealth creation.',
  ...
  (
    ...
    'Current gold prices as of March 2024: 24K gold is trading at ₹6,245 per gram, while 22K gold is at ₹5,725 per gram. Gold prices have shown an upward trend of approximately 12% year-over-year due to global economic uncertainty, inflation concerns, and geopolitical tensions. The RBI report indicates continued demand from both retail and institutional investors. Gold ETFs have seen increased inflows, making them an attractive option for portfolio diversification.',
  ...
  (
    ...
    'Amaravati real estate market shows promising growth potential with current average property prices at ₹4,500 per sq ft. The region is experiencing 8% annual growth due to ongoing infrastructure development, including the new capital city project and improved connectivity. However, consider these factors: 1) Regulatory approvals are still pending for some projects, 2) Infrastructure development timeline may face delays, 3) Market liquidity is relatively low compared to established cities. Recommendation: Suitable for long-term investors (5+ years) with moderate risk tolerance.',
  ...
  (
    ...
    'For HDFC Top 100 Fund investment comparison: SIP (Systematic Investment Plan) offers rupee cost averaging benefits, reducing market timing risk and making it suitable for regular income earners. Historical data shows SIP returns of 11.8% annually over 10 years. Lump sum investment can potentially generate higher returns (13.1% historically) if market timing is favorable, but carries higher risk. Recommendation: SIP for beginners and regular investors, lump sum for experienced investors with market knowledge and surplus funds during market corrections.',
  ...
  (
    ...
    'Based on the LIC ULIP comparison analysis: LIC New Jeevan Anand offers the best balance of returns and insurance coverage with projected returns of 8-10% annually. LIC ULIP plans show varying performance: Tech Fund (12% average), Balanced Fund (9% average), and Debt Fund (7% average). However, consider high charges in initial years (3-5% of premium). For pure investment purposes, mutual funds typically offer better returns. LIC policies are recommended primarily for insurance needs with investment as secondary benefit.',
