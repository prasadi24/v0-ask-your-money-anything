                ...
                {sampleQuestions.map((category, index) => (
                  <div key={index}>
                    <div className="flex items-center space-x-2 mb-2">
                      <category.icon className="h-4 w-4 text-brand-gold" />
                    ...
                    <div className="space-y-1">
                      {category.questions.map((question, qIndex) => (
                        <button
                          ...
                          className="text-left text-xs text-gray-600 hover:text-brand-navy block w-full p-2 rounded hover:bg-brand-gold/10 transition-colors"
                        >
                          {question}
                        </button>
                      ))}
                          ...
                          >
                            ...
                            <div
                              className={`rounded-lg p-4 ${
                                message.role === "user" ? "bg-brand-navy text-white" : "bg-gray-100 text-gray-900"
                              }`}
                            >
