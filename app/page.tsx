...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-24">
      ...
      <Card className="w-[350px]">
        ...
        <CardContent>
          <form>
            ...
            <Button className="bg-navy-800 hover:bg-navy-900 text-artha-400 mt-4">Create account</Button>
          </form>
        </CardContent>
      </Card>
      <Table>
      ...
      <Button className="border-navy-800 text-navy-800 hover:bg-artha-50">Click me</Button>
    </main>
  )
}
