      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Decode Your{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-artha-500 to-navy-800">Wealth</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link href="/ask">
              <Button size="lg" className="text-lg px-8 py-4 h-auto bg-navy-800 hover:bg-navy-900 text-artha-400">
      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <Shield className="h-10 w-10 text-navy-600 mb-4" />
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/ask">
                <Button
                  size="lg"
                  className="text-lg px-8 py-4 h-auto bg-artha-500 text-navy-900 hover:bg-artha-400 hover:text-navy-800"
                >
                  Start Free Trial
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
